  ...
  return (
    <Layout maxWidth="max-w-md">
      <div className="card p-8 text-center mt-8">
        {loading ? <Loader2 size={22} className="animate-spin mx-auto my-6" style={{ color: 'var(--text-dim)' }} /> : error && !preview ? (
          <>
            ...
            <h1 className="text-lg font-bold mb-2" style={{ color: 'var(--text)' }}>Invitation invalide</h1>
          ...
          <>
            ...
            <h1 className="text-xl font-bold mb-1" style={{ color: 'var(--text)' }}>Rejoindre {preview.organisationNom}</h1>
            <p className="text-sm mb-1" style={{ color: 'var(--text-muted)' }}>Tu as été invité à rejoindre cette organisation sur Gbairai.</p>
            <p className="text-2xs mb-6" style={{ color: 'var(--text-dim)' }}>{preview.places} place{preview.places !== 1 ? 's' : ''} disponible{preview.places !== 1 ? 's' : ''}</p>
