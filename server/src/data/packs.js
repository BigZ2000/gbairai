...
export const PACKS = [
  ...
  // Vides tant que le pack « Drapeaux du Monde » n'est pas importé (Admin → Import).
  {
    ...
    couleur: '#6366F1', categories: ['Drapeaux'], difficulte: 'MIXTE',
  ...
  },
  {
    ...
    couleur: '#22C55E', categories: ['Drapeaux'], difficulte: 'MIXTE',
  ...
  },
  {
    ...
    couleur: '#16A34A', categories: ['Drapeaux'], difficulte: 'FACILE',
  ...
  },
  {
    ...
    couleur: '#3B82F6', categories: ['Drapeaux'], difficulte: 'MIXTE',
  ...
  },
  {
    ...
    couleur: '#8B5CF6', categories: ['Drapeaux'], difficulte: 'MIXTE',
